return {
    {
        ...
        config = function()
            ...
            local cmp_mappings = lsp.defaults.cmp_mappings({
                ...
                -- ["<C-S-d>"] = cmp.mapping.scroll_docs(5),
            ...
            lsp.on_attach(function(_, bufnr)
                ...
                map("n", "<leader>od", function() vim.diagnostic.open_float() end, opts("Open floating diagnostics"))
                ...
                map("n", "<leader>va", function() vim.lsp.buf.code_action() end, opts("Code action"))
